...
model_path_unext50 = '/data/shaozc/Kaggle-HuBMAP/output/model/7/7_CustomUneXt50_kfold_1_bestloss.ckpt'
model_path_cenet = '/data/shaozc/Kaggle-HuBMAP/output/model/14/14_CustomUneXt50_kfold_1_bestloss.ckpt'
model_path_enresnet  = '/data/shaozc/Kaggle-HuBMAP/output/dummy/en-resnet34-256-aug-corrected/fold2/checkpoint/00008500_model.pth'

img_path = '/data/shaozc/Kaggle-HuBMAP/test/'
label_dir = '/data/shaozc/Kaggle-HuBMAP/submission.csv'
submit = '/data/shaozc/Kaggle-HuBMAP/submit/Ensemble/'

models_to_consider = {#'unext50': model_path_unext50, 
                      'cenet': model_path_cenet, 
                      'enresnet': model_path_enresnet}
