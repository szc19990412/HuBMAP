...
#-------Init部分-------#
    def __init__(self, cfg):
        ...
        m1 = timm.create_model('ssl_resnext50_32x4d', pretrained=True)
        #提取fc层中固定的参数
        fc_features = m1.fc.in_features #模型的fc层，in_features参数
        #修改类别为9
        m1.fc = nn.Linear(fc_features, 1) #修改模型的fc层
        self.net = m1
