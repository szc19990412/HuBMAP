...
def make_parse():
    ...
    arg("--tile-size", type=int, default=512)
    arg("--tile-average-step", type=int, default=256)
    arg("--data-dir", type=str, default='/data/shaozc/Kaggle-HuBMAP')
    arg("--train-tile-dir", type=str, default=f'/data/shaozc/Kaggle-HuBMAP/0.25_1024_512_train_corrected')
...
def run_make_train_tile():
    ...
    for i in tqdm(range(0,len(df_train))):
        ...
        save_pyramid(mask,'/data/shaozc/Kaggle-HuBMAP/mask/%s.png'%id)
